...
@section('title', 'REMOVEDOR DE GRASA')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>REMOVEDOR DE GRASA</li>
        </ol>
        <h2>REMOVEDOR DE GRASA</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/grease-remover-3.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>REMOVEDOR DE GRASA</h3>
              <h5>Descripción General</h5>
              <p style="text-align: justify;">
                Quitagrasas, especialmente formulado para ropa TST. Se mezcla con agua y se aplica sobre la prenda sucia con una brocha.
              </p>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
                <li><strong>Número de artículo: </strong>5092000</li>
                <li><strong>TALLAS: </strong>0,5 litros, 2,5 litros</li>
