...
@section('title', 'PANTALÓN 20/30 ÉLITE')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>PANTALÓN 20/30 ÉLITE</li>
        </ol>
        <h2>PANTALÓN 20/30 ÉLITE</h2>
      </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
              	...
              	<li>•    Calce ajustado para mayor comodidad.</li>
              	<li>•    Protección frontal completa hasta la cintura.</li>
              	<li>•    Extra alta resistencia al desgaste en las rodillas y en la parte inferior de los pantalones. Bolsillos en las rodillas para rodilleras.</li>
              	<li>•    Tirantes ajustables, cintura trasera elástica y cinturón que ayuda a distribuir el peso y mejora la comodidad.</li>
                <li>•    La ventilación es una opción.</li>
                <li>•    Parte del Kit Gamma y Kit Delta.</li>
                <li>•    Reglamento CE (UE) 2016/425.</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
              	<li><strong>Número de artículo: </strong>51320685075</li>
              	<li><strong>TALLAS: </strong>S/M - 4XL/5XL</li> <br>
