...
@section('title', 'PANTALONES 10/28')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>PANTALONES 10/28</li>
        </ol>
        <h2>PANTALONES 10/28</h2>
      </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>PANTALONES 10/28</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>Los pantalones están equipados con protección frontal completa hasta la cintura. Las cremalleras en el exterior de las piernas están protegidas por una solapa de sellado y una solapa de velcro. Tirantes anchos y ajustables en material elástico. Parte elástica en la parte trasera de la cintura y cinturón que ayuda a repartir el peso y mejora el confort. Los pantalones son muy populares entre los trabajadores que se mueven mucho, trepan o gatean. Disponible con Ventilación.</li>
              ...
              <ul>
                <li><strong>Número de artículo: </strong>5132047</li>
                <li><strong>TALLAS: </strong>S/M, L/XL, 2XL/3XL</li> <br>
