...
@section('title', 'BOTAS PROOPERATOR 5/5/3')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>BOTAS PROOPERATOR 5/5/3</li>
        </ol>
        <h2>BOTAS PROOPERATOR 5/5/3</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/arm-protection-5-5-2.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>BOTAS PROOPERATOR 5/5/3</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>Botas protectoras, impermeables y con certificado CE. Probado para soportar líquidos presurizados y fluidos hidráulicos de alta presión hasta 500 bar/7500 psi de presión. Las botas están diseñadas profesionalmente para horas y horas de trabajo duro. Goma completamente vulcanizada con refuerzo para aguantar líquidos a presión en el pie (partes negras). También provista de puntera de acero e inserciones de acero para aguantar objetos cortantes por debajo. Forro interior textil para un buen confort. La suela está diseñada para un buen agarre. Si se necesita agarre adicional, por ejemplo, en invierno, se puede equipar con clavos. La caña de la bota se puede apretar con una correa ajustable. Se vende en pares.</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
                <li><strong>Número de artículo: </strong>5652025</li>
                <li><strong>TALLAS: </strong>STL 36, STL 37, STL 38, STL 39, STL 40, STL 41, STL 42, STL 43, STL 44, STL 45, STL 46, STL 47, STL 48</li> <br>
