...
@section('title', 'DELTA KIT 20/30 ELITE')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>DELTA KIT 20/30 ELITE</li>
        </ol>
        <h2>DELTA KIT 20/30 ELITE</h2>
      </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
              	...
              	<li>•    Conforme y cómodo.</li>
              	<li>•    La ventilación es una opción.</li>
              	<li>•    Una gran elección en ambientes cálidos.</li>
              	<li>•    Reglamento CE (UE) 2016/425.</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
              	<li><strong>Número de artículo: </strong>51K10685075</li>
