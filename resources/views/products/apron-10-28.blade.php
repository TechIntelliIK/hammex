    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>DELANTAL 28/10</li>
        </ol>
        <h2>DELANTAL 28/10</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/apron-10-28.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>DELANTAL 28/10</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>El área completa del Delantal tiene protección incorporada. La posición del delantal se puede cambiar a través de la banda ajustable para el hombro. La construcción especial de esta banda ayuda a repartir el peso del Delantal, lo cual es un importante detalle de comodidad. El Delantal se puede plegar y sujetar, para facilitar el trabajo en escaleras y escaleras. Muy fácil de poner y quitar. Recomendado para trabajos en superficies planas y se usa a menudo en combinación con protecciones para manos y polainas o botas 3000. El delantal viene en un tamaño.</li>
              ...
              <ul>
                <li><strong>Número de artículo: </strong>5123047</li>
