...
@section('title', 'CHALECO 20/30 ÉLITE')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>CHALECO 20/30 ÉLITE</li>
        </ol>
        <h2>CHALECO 20/30 ÉLITE</h2>
      </div>
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/vest-20-30-elite.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
              	...
              	<li>•    Protección eficaz y confort óptimo.</li>
              	<li>•    Parte del Kit Sigma y Kit Delta.</li>
              	<li>•    Reglamento CE (UE) 2016/425.</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
              	<li><strong>Número de artículo: </strong>51200685075</li>
