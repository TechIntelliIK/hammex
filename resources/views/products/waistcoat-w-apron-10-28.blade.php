...
@section('title', 'CHALECO W. DELANTAL 28/10')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>CHALECO W. DELANTAL 28/10</li>
        </ol>
        <h2>CHALECO W. DELANTAL 28/10</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/waistcoat-w-apron-10-28.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>CHALECO W. DELANTAL 28/10</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>Una combinación bien pensada entre el chaleco y el delantal que brinda una mayor libertad de movimiento y comodidad, pero aún ofrece una protección efectiva para todo el frente del cuerpo. La construcción con chaleco en la parte superior ayuda a distribuir el peso de la prenda protectora. Las Manoplas y Polainas o Botas 3000 son complementos idóneos para una protección prolongada.</li>
              ...
              <ul>
                <li><strong>Número de artículo: </strong>5123547</li>
