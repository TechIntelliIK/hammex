...
@section('title', 'CHAQUETA 5/5/2 HI VIS')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>CHAQUETA 5/5/2 HI VIS</li>
        </ol>
        <h2>CHAQUETA 5/5/2 HI VIS</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/jacket-5-5-2-hi-vis.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>CHAQUETA 5/5/2 HI VIS</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>Chaqueta funcional de 2 capas con certificación CE para protección contra limpieza a alta presión y probada para fluido hidráulico a alta presión. Muy suave y flexible de llevar. Forrado para mayor comodidad. Repelente al agua y la suciedad en el exterior. Detalles bien pensados ​​como ventilación que se puede abrir en las axilas, puños cómodos y capucha espaciosa ajustable.</li>
                <li>•    Material exterior: Recubierto para repeler el agua y la suciedad.</li>
                ...
                <li>•    Homologado según el Reglamento (UE) 2016/425.</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
                <li><strong>Número de artículo: </strong>56220255690</li>
