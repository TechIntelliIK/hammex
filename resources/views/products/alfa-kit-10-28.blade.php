    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>KIT ALFA 10/28</li>
        </ol>
        <h2>KIT ALFA 10/28</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/alfa-kit-10-28.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>KIT ALFA 10/28</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>El Alfa Kit es una combinación selecta con un precio atractivo. Incluye:</li>
                <li>•    Chaleco con Delantal.</li>
                <li>•    Protecciones de Manos.</li>
              ...
              <ul>
                <li><strong>Número de artículo: </strong>51K4047</li>
