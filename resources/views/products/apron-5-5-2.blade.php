    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>DELANTAL 5/5/2</li>
        </ol>
        <h2>DELANTAL 5/5/2</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/apron-5-5-2.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>DELANTAL 5/5/2</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>El área completa del Delantal tiene protección incorporada. Buena alternativa en ambientes cálidos. El Delantal está equipado con una nueva banda para el hombro inteligentemente diseñada que mejora la comodidad del operador. Correctamente ajustado, distribuye el peso muy bien. Fácil de ponerse y quitarse.</li>
              ...
              <ul>
                <li><strong>Número de artículo: </strong>5623025</li>
