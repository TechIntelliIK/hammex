...
@section('title', 'CUBIERTA DE CONEXIÓN DE MANGUERA 61 MM')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>CUBIERTA DE CONEXIÓN DE MANGUERA 61 MM</li>
        </ol>
        <h2>CUBIERTA DE CONEXIÓN DE MANGUERA 61 MM</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/hose-connection-cover-61mm.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>CUBIERTA DE CONEXIÓN DE MANGUERA 61 MM</h3>
              <h5>Descripción General</h5>
              <p style="text-align: justify;">
                La cubierta de conexión de la manguera es un dispositivo de seguridad diseñado para colocarse donde las mangueras tienen acoplamientos y conexiones, por ejemplo, en los pedales y las bombas. Una correa ajustable sujeta la cubierta de conexión de forma segura en su lugar. En el otro extremo, hay bucles para sujetar o ensamblar varias cubiertas. No se prueba para "fugas por orificios pequeños", sino para rotura de manguera a 3000 bar / 43500 psi.
              </p>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
                <li><strong>Número de artículo: </strong>5071000</li>
                <li><strong>TALLAS: </strong>400 mm, 5m</li>
