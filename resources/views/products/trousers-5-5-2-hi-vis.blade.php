...
@section('title', 'PANTALÓN 5/5/2 HI VIS')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>PANTALÓN 5/5/2 HI VIS</li>
        </ol>
        <h2>PANTALÓN 5/5/2 HI VIS</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/trousers-5-5-2-hi-vis.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>PANTALÓN 5/5/2 HI VIS</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>Cintura elástica ajustable para un ajuste perfecto. Detalles prácticos como bolsillo para navaja, bolsillo para pierna y trabillas dobles para cinturón. Las cremalleras en las piernas permiten que se ensanchen para facilitar el calce de las botas.</li>
              ...
              <ul>
                <li><strong>Número de artículo: </strong>56320255690</li>
