...
@section('title', 'PROTECCIÓN PARA LA CABEZA 20/30 – CASCO CON PROTECCIÓN AUDITIVA Y VISERA')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>PROTECCIÓN PARA LA CABEZA 20/30 – CASCO CON PROTECCIÓN AUDITIVA Y VISERA</li>
        </ol>
        <h2>PROTECCIÓN PARA LA CABEZA 20/30 – CASCO CON PROTECCIÓN AUDITIVA Y VISERA</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/head-protection-20-30.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>PROTECCIÓN PARA LA CABEZA 20/30 – CASCO CON PROTECCIÓN AUDITIVA Y VISERA</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>Casco con Visera, Protectores Auditivos. Todas las piezas están probadas y certificadas para protección contra líquidos con presión de hasta 3000 bar/43500 psi. El casco también cumple con los requisitos para cascos de seguridad industrial. El interior es cómodo y se puede ajustar a un ajuste muy bueno. La visera cumple con los requisitos de protección ocular. Es reemplazable y se puede colocar en posición plegada. Los protectores auditivos están clasificados. SNR=32dB. Se pueden ajustar verticalmente y colocar en diferentes posiciones contra la cabeza, para una protección y un ajuste óptimos. La correa para la barbilla de 3 puntos se suministra en el kit de protección para la cabeza.</li>
                <li>•    El casco está fabricado en poliamida reforzada con fibra de vidrio.</li>
                <li>•    Rango de temperatura -30° a +150°.</li>
                <li>•    Marcado CE, aprobado según:</li>
                <li>•    Cascos de seguridad industrial - SS-EN397:2012</li>
                <li>•    Protección ocular - SS-EN166:2001</li>
                <li>•    Protección auditiva - SS-EN 352-3:2002</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
                <li><strong>Número de artículo: </strong>5102068</li>
                <li><strong>TALLAS: </strong>talla única</li> <br>
