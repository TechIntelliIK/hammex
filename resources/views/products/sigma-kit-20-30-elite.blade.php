...
@section('title', 'SIGMA KIT 20/30 ELITE')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>SIGMA KIT 20/30 ELITE</li>
        </ol>
        <h2>SIGMA KIT 20/30 ELITE</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/sigma-kit-20-30-elite.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>SIGMA KIT 20/30 ELITE</h3>
              <h5>Descripción General</h5>
              <ul>
              	<li>•    Mayor movilidad en el Overall gracias a las rodillas predobladas y al material protector flexible, así como al material elástico en la espalda. Chaleco de nuevo diseño con material protector más flexible que aumenta la movilidad y la protección.</li>
              	<li>•   El Overol protege la parte inferior del cuerpo, el Chaleco la parte superior del cuerpo</li>
              	<li>•    La ventilación es una opción.</li>
              	<li>•    Una buena opción si te mueves, trepas o gateas mucho. • Reglamento CE (UE) 2016/425</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
              	<li><strong>Número de artículo: </strong>51K20685075</li>
