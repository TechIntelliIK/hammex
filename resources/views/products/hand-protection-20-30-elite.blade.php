...
@section('title', 'PROTECCIÓN MANOS 20/30 ÉLITE')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>PROTECCIÓN MANOS 20/30 ÉLITE</li>
        </ol>
        <h2>PROTECCIÓN MANOS 20/30 ÉLITE</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/hand-protection-20-30-elite.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>PROTECCIÓN MANOS 20/30 ÉLITE</h3>
              <h5>Descripción General</h5>
              <ul>
              	<li>•    Protege toda la zona del antebrazo y el dorso de la mano.</li>
              	<li>•    Fácil de poner y se mantiene en su lugar con una correa para el pulgar.</li>
              	<li>•    Fácil ajuste para diferentes brazos y ropa.</li>
              	<li>•    Diseños específicos para mano derecha e izquierda. Se vende en pares.</li>
              	<li>•    Parte del Kit Alfa y Sigma.</li>
                <li>•    Reglamento CE (UE) 2016/425</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
              	<li><strong>Número de artículo: </strong>51000685075</li>
