...
@section('title', 'GUANTES 500BAR W. GUANTE INTERIOR, PAQUETE DE 12')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>GUANTES 500BAR W. GUANTE INTERIOR, PAQUETE DE 12</li>
        </ol>
        <h2>GUANTES 500BAR W. GUANTE INTERIOR, PAQUETE DE 12</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/gloves-500bar-w-inner-glove-pack-of-12.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>GUANTES 500BAR W. GUANTE INTERIOR, PAQUETE DE 12</h3>
              <h5>Descripción General</h5>
              <p style="text-align: justify;">
                Guantes impermeables con protección hasta 500 bar de presión. Los guantes tienen una superficie áspera con patrón de arena y el material en sí proporciona mucha fricción, todo para un mejor agarre. Guantes interiores separados en nylon para una buena comodidad. Los guantes también han sido probados y clasificados con los valores más altos de protección contra cortes y abrasión, desgarro y punción. El exterior está sumergido en caucho de nitrilo. Vida útil de hasta 3 años. Certificado de acuerdo con la directiva CE. Los guantes no soportan fluidos hidráulicos a alta presión. Se suministra en pack de 12 pares.
              </p>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
                <li><strong>Número de artículo: </strong>5600025</li>
                <li><strong>TALLAS: </strong>9, 11</li>
