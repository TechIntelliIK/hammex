...
@section('title', 'CHAQUETA W. PROTECCIONES DE MANOS 10/28')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>CHAQUETA W. PROTECCIONES DE MANOS 10/28</li>
        </ol>
        <h2>CHAQUETA W. PROTECCIONES DE MANOS 10/28</h2>
      </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>CHAQUETA W. PROTECCIONES DE MANOS 10/28</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>La chaqueta proporciona una protección frontal completa y eficaz, así como alrededor del cuello y los hombros. También tiene protecciones para las manos integradas. Lo ideal es combinarlo con Head Protection 20/30, Pantalones y Polainas o Botas 3000 para una máxima protección.</li>
              ...
              <ul>
                <li><strong>Número de artículo: </strong>5122047</li>
