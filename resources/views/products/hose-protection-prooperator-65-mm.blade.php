...
@section('title', 'PROTECCIÓN DE MANGUERA PROOPERATOR 65 MM')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>PROTECCIÓN DE MANGUERA PROOPERATOR 65 MM</li>
        </ol>
        <h2>PROTECCIÓN DE MANGUERA PROOPERATOR 65 MM</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/hose-protection-prooperator-65-mm.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>PROTECCIÓN DE MANGUERA PROOPERATOR 65 MM</h3>
              ...
              <ul>
                <li><strong>Número de artículo: </strong>5660063</li>
                <li><strong>TALLAS: </strong>750mm, 3000mm</li> <br>
