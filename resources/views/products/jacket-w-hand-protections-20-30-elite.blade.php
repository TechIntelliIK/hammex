...
@section('title', 'CHAQUETA W. PROTECCIONES MANOS 20/30 ELITE')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>CHAQUETA W. PROTECCIONES MANOS 20/30 ELITE</li>
        </ol>
        <h2>CHAQUETA W. PROTECCIONES MANOS 20/30 ELITE</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/jacket-w-hand-protections-20-30-elite.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>CHAQUETA W. PROTECCIONES MANOS 20/30 ELITE</h3>
              <h5>Descripción General</h5>
              <ul>
              	<li>•    Mayor movilidad y comodidad gracias al material de protección flexible, tejido elástico y nuevo diseño.</li>
              	<li>•    Calce ajustado para mayor comodidad. Zona de protección ampliada en el torso y en el lateral.</li>
              	<li>•    Protección frontal completa, así como en cuello, hombros y toda la zona del antebrazo.</li>
              	<li>•    Cierre en la parte trasera para conseguir una protección total en la parte delantera.</li>
              	<li>•    Parte del Kit Gamma.</li>
                <li>•    Reglamento CE (UE) 2016/425.</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
              	<li><strong>Número de artículo: </strong>51220685075</li>
