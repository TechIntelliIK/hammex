...
@section('title', 'PROTECCIÓN DE BRAZOS 5/5/2')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>PROTECCIÓN DE BRAZOS 5/5/2</li>
        </ol>
        <h2>PROTECCIÓN DE BRAZOS 5/5/2</h2>
      </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>PROTECCIÓN DE BRAZOS 5/5/2</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>Las protecciones de brazo tienen protección integrada alrededor del brazo, desde la muñeca hasta la parte superior del brazo. Puños elásticos en ambos extremos para una fácil colocación y un buen ajuste. Desarrollado y recomendado para el personal que trabaja en bancos de pruebas para hidráulica. Probado para soportar fluidos hidráulicos a alta presión. Disponible en dos longitudes: XS/M (40 CM) y L/2XL (50 CM).</li>
              ...
              <ul>
                <li><strong>Número de artículo: </strong>5602025</li>
                <li><strong>TALLAS: </strong>XS/M, L/2XL</li> <br>
