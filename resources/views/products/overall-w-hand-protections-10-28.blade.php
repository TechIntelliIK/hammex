...
@section('title', 'EN GENERAL W. PROTECCIONES DE MANOS 10/28')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>EN GENERAL W. PROTECCIONES DE MANOS 10/28</li>
        </ol>
        <h2>EN GENERAL W. PROTECCIONES DE MANOS 10/28</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/trousers-10-28.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>EN GENERAL W. PROTECCIONES DE MANOS 10/28</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>Protección contra chorros de agua en toda la parte delantera de las piernas hasta la cintura, en los antebrazos y las protecciones de manos integradas. El cuello de neopreno sella bien alrededor del cuello mientras mantiene la libertad de movimiento. Un Overol siempre está en su lugar, sin importar si el operador está subiendo escaleras o trabajando en espacios estrechos. Idealmente combinado con Protección para la Cabeza 20/30, Chaleco y Polainas o Botas 3000. Disponible con Ventilación.</li>
              ...
              <ul>
                <li><strong>Número de artículo: </strong>5144047</li>
                <li><strong>TALLAS: </strong>S, METRO, L, SG, 2XL, 3XL</li> <br>
