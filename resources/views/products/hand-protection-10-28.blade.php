...
@section('title', 'PROTECCIÓN DE MANOS 10/28')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>PROTECCIÓN DE MANOS 10/28</li>
        </ol>
        <h2>PROTECCIÓN DE MANOS 10/28</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/hand-protection-10-28.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>PROTECCIÓN DE MANOS 10/28</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>La Hand Protection protege la mano y el antebrazo. Toda la zona alrededor del brazo está protegida. Fácil de poner y una correa para el pulgar lo mantiene en su lugar. Diseños específicos para mano derecha e izquierda. Se vende en pares.</li>
                <li>•    Material exterior: Poliamida Laminada.</li>
                <li>•    Material interior: Poliamida Laminada.</li>
              ...
              <ul>
                <li><strong>Número de artículo: </strong>5100047</li>
