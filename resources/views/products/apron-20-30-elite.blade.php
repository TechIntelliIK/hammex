...
@section('title', 'DELANTAL 20/30 ÉLITE')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>DELANTAL 20/30 ÉLITE</li>
        </ol>
        <h2>DELANTAL 20/30 ÉLITE</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/apron-20-30-elite.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>DELANTAL 20/30 ÉLITE</h3>
              <h5>Descripción General</h5>
              <ul>
              	<li>•    Protección en toda el área de la Plataforma.</li>
              	<li>•    Banda de hombro ajustable para mayor comodidad y fácil colocación.</li>
              	<li>•    Muy fácil de poner y quitar. Puede ser utilizado fácilmente por múltiples operadores.</li>
              	<li>•    Se puede plegar y sujetar para facilitar el trabajo en escaleras y escaleras.</li>
              	<li>•    Reglamento CE (UE) 2016/425.</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
              	<li><strong>Número de artículo: </strong>51230685075</li>
