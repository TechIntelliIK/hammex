...
@section('title', 'PROTECCIÓN CUELLO 20/30 ÉLITE')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>PROTECCIÓN CUELLO 20/30 ÉLITE</li>
        </ol>
        <h2>PROTECCIÓN CUELLO 20/30 ÉLITE</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/neck-protection-20-30-elite.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>PROTECCIÓN CUELLO 20/30 ÉLITE</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>•    Excelente complemento del Head Protection 20/30.</li>
                <li>•    Protege las zonas sensibles entre el Head Protection 20/30 y la Chaqueta/Chaleco.</li>
                <li>•    Se conecta a la parte trasera de Head Protection 20/30. Cierra con ganchos y bucles en frente de la cara. • Se puede llevar dentro o fuera de la visera.</li>
                <li>•    Se recomienda ventilación.</li>
                <li>•    CE: Reglamento (UE) 2016/425</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
                <li><strong>Número de artículo: </strong>51105685075</li>
