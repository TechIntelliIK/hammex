...
@section('title', 'POLAINAS 20/30 ELITE')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>POLAINAS 20/30 ELITE</li>
        </ol>
        <h2>POLAINAS 20/30 ELITE</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/gaiters-20-30-elite.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>POLAINAS 20/30 ELITE</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>•    Para ser usado en el exterior de las botas de protección regulares.</li>
                <li>•    Se protege toda la zona alrededor de la pierna y el pie.</li>
                <li>•    Muy cómodo y ligero de llevar.</li>
                <li>•    Fácil de ajustar para un ajuste perfecto.</li>
                <li>•    Diseños específicos para pie derecho e izquierdo. Se vende en pares.</li>
                <li>•    Reglamento CE (UE) 2016/425.</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
                <li><strong>Número de artículo: </strong>51580685075</li>
                <li><strong>TALLAS: </strong>42-48, 49-52</li> <br>
