...
@section('title', 'PROTECCIÓN MANGUERA 59MM')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>PROTECCIÓN MANGUERA 59MM</li>
        </ol>
        <h2>PROTECCIÓN MANGUERA 59MM</h2>
      </div>
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/hose-protection-59mm.webp') }}" alt="">
                </div>
              </div>
