...
@section('title', 'ALFA KIT 20/30 ELITE')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>ALFA KIT 20/30 ELITE</li>
        </ol>
        <h2>ALFA KIT 20/30 ELITE</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/delta-kit-20-30-elite.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>ALFA KIT 20/30 ELITE</h3>
              <h5>Descripción General</h5>
              <ul>
              	<li>•    Chaleco con delantal en un nuevo diseño con material protector más flexible que aumenta la movilidad y la protección.</li>
              	<li>•    Protección sobre los hombros y hasta abajo.</li>
              	<li>•    Fácil de cambiar entre usuarios, por ejemplo, si lo utilizan varios operadores.</li>
              	<li>•    Una excelente opción para trabajos estacionarios y en ambientes cálidos.</li>
              	<li>•    Reglamento CE (UE) 2016/425.</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
              	<li><strong>Número de artículo: </strong>51K40685075</li>
              	<li><strong>TALLAS: </strong>S/M - 2XL/3XL</li> <br>
