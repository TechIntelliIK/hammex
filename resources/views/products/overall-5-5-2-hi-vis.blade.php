...
@section('title', 'EN GENERAL 5/5/2 ALTA VISIBILIDAD')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>EN GENERAL 5/5/2 ALTA VISIBILIDAD</li>
        </ol>
        <h2>EN GENERAL 5/5/2 ALTA VISIBILIDAD</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/overall-5-5-2-hi-vis.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>EN GENERAL 5/5/2 ALTA VISIBILIDAD</h3>
              ...
              <ul>
                <li><strong>Número de artículo: </strong>56400255690</li>
