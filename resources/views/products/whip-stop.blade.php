...
@section('title', 'PARADA DE LÁTIGO/COMPROBACIÓN')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>PARADA DE LÁTIGO/COMPROBACIÓN</li>
        </ol>
        <h2>PARADA DE LÁTIGO/COMPROBACIÓN</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/whip-stop.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>PARADA DE LÁTIGO/COMPROBACIÓN</h3>
              <h5>Descripción General</h5>
              <p style="text-align: justify;">
                Una excelente manera de asegurar los extremos de las mangueras en los pedales, bombas o conexiones. Si está correctamente montado, atrapará una manguera rota y evitará que se azote. El tope de látigo se monta deslizándolo sobre los extremos de la manguera, estirándolo y finalmente apretando los extremos y asegurándolo con los anillos de seguridad de goma. Longitud aprox. 2,5 pies de ancho aprox. 1 pulg. Se vende en paquetes que incluyen 50 piezas.
              </p>
              <ul>
                <li>Resistencia a la tracción 30 kN.</li>
                <li>Producido y probado de acuerdo con EN 12195-2.</li>
                <li>(Método de prueba: SS-EN 12195-2. Conjuntos de retención de carga - Seguridad - Parte 2: Trincaje de cincha hecho de fibras sintéticas).</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
                <li><strong>Número de artículo: </strong>5072000</li>
                <li><strong>TALLAS: </strong>75 cm / 2,5 pies</li>
