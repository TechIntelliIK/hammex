    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>KIT GAMMA 10/28</li>
        </ol>
        <h2>KIT GAMMA 10/28</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/gamma-kit-10-28.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>KIT GAMMA 10/28</h3>
              <h5>Descripción General</h5>
              <ul>
              	<li>El Kit Gamma es una combinación selecta con un precio atractivo. Incluye:</li>
              	<li>•    Pantalones</li>
              	<li>•    Chaqueta con protección para las manos integrada La ventilación es una opción.</li>
              ...
              <ul>
              	<li><strong>Número de artículo: </strong>51K3047</li>
