...
@section('title', 'Wheel Jet 11 300-18-0-e')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>Wheel Jet 11 300-18-0-e</li>
        </ol>
        <h2>Wheel Jet 11 300-18-0-e</h2>
      </div>
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/wheel-jet-11-300-18-0-e/wheel-jet-11-300-18-0-e-1.webp') }}" alt="">
                </div>
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/wheel-jet-11-300-18-0-e/wheel-jet-11-300-18-0-e-2.webp') }}" alt="">
                </div>
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/wheel-jet-11-300-18-0-e/wheel-jet-11-300-18-0-e-3-550x550.webp') }}" alt="">
                </div>
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/wheel-jet-11-300-18-0-e/wheel-jet-11-300-18-0-e-4.webp') }}" alt="">
                </div>
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/wheel-jet-11-300-18-0-e/wheel-jet-11-300-18-0-e-5.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Presión:</strong> Máx.: 300 bar (4.351,13 psi) Mín.: 30 bar (435,11 psi)</li>
                <li><strong>Caudal de agua:</strong>  Máx.: 18 l/min (4,76 us gal/min) Mín.: 8 l/min (2,11 us gal/min)</li>
                <li><strong>SKU:</strong> wheel jet 11 300-18-0-e</li>
                <li><strong>Categorías:</strong> Electrico, Falch</li>
                <li><strong>Etiquetas:</strong> agua fría, alta presión, móvil, trifásico</li><br>
                                  ...
                                  <div class="table-responsive">
                                      <table class="table table-striped align-middle">
                                          ...
                                          <tbody>
                                              ...
                                              <tr>
                                                  <th scope="row">motor eléctrico potencia max. /potencia de salida, velocidad de funcionamiento, régimen delralentí, sistema de refrigeración</th>
                                                  <td>13 kw / 11 kw, 1460 rpm, -, air</td>
                                              </tr>
                                              <tr>
                                              ...
                                              <tr>
                                                  ...
                                                  <td>11 kw, 1460 rpm, 2,0 – 8,0 bar, 40 °c</td>
                                              </tr>
                                              <tr>
