    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>DELTA KIT 10/28</li>
        </ol>
        <h2>DELTA KIT 10/28</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/delta-kit-10-28.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>DELTA KIT 10/28</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>El Delta Kit es una combinación selecta con un precio atractivo. Incluye:</li>
                <li>•    Chaleco</li>
                <li>•    Pantalón</li>
                <li>•    Protecciones de manos La ventilación es opcional.</li>
              ...
              <ul>
                <li><strong>Número de artículo: </strong>51K1047</li>
