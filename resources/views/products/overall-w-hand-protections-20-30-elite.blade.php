...
@section('title', 'EN GENERAL W. PROTECCIONES MANOS 20/30 ELITE')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>EN GENERAL W. PROTECCIONES MANOS 20/30 ELITE</li>
        </ol>
        <h2>EN GENERAL W. PROTECCIONES MANOS 20/30 ELITE</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/trousers-20-30-elite.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>EN GENERAL W. PROTECCIONES MANOS 20/30 ELITE</h3>
              <h5>Descripción General</h5>
              <ul>
              	<li>•    Mayor movilidad gracias a las rodillas predobladas y al material protector flexible, así como al material elástico en la espalda.</li>
              	<li>•    Nuevo diseño con piernas que se abren desde las rodillas para abajo.</li>
              	<li>•    Protección en toda la parte delantera de las piernas hasta la cintura y en la zona del antebrazo. Nota: Sin protección en la parte superior del cuerpo. Debe usarse junto con el chaleco.</li>
              	<li>•    El cuello de neopreno sella bien alrededor del cuello mientras mantiene la libertad de movimiento.</li>
              	<li>•    El Overol permanece en su lugar, ya sea que el operador esté subiendo escaleras o trabajando en espacios angostos.</li>
                <li>•    La ventilación es una opción.</li>
                <li>•    Parte del Kit Sigma.</li>
                <li>•    Reglamento CE (UE) 2016/425.</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
              	<li><strong>Número de artículo: </strong>51440685075</li>
              	<li><strong>TALLAS: </strong>S-3XL</li> <br>
