...
@section('title', 'KIT GAMMA 20/30 ELITE')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>KIT GAMMA 20/30 ELITE</li>
        </ol>
        <h2>KIT GAMMA 20/30 ELITE</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/gamma-kit-20-30-elite.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>KIT GAMMA 20/30 ELITE</h3>
              <h5>Descripción General</h5>
              <ul>
              	<li>•    Mayor movilidad y comodidad gracias al material de protección flexible, nuevo diseño, tejido elástico y rodillas predobladas en los pantalones.</li>
              	<li>•    Protección frontal completa, así como alrededor del cuello, los hombros y toda la zona del antebrazo.</li>
              	<li>•    La ventilación es una opción.</li>
              	<li>•    Una excelente opción para trabajos que requieren movimiento.</li>
              	<li>•    Reglamento CE (UE) 2016/425.</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
              	<li><strong>Número de artículo: </strong>51K30685075</li>
