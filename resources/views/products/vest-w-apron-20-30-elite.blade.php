...
@section('title', 'CHALECO W. DELANTAL 20/30 ÉLITE')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>CHALECO W. DELANTAL 20/30 ÉLITE</li>
        </ol>
        <h2>CHALECO W. DELANTAL 20/30 ÉLITE</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/vest-w-apron-20-30-elite.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>CHALECO W. DELANTAL 20/30 ÉLITE</h3>
              <h5>Descripción General</h5>
              <ul>
              	<li>•    Ajuste y superficie de protección mejorados gracias a la gama de tallas ampliada.</li>
              	<li>•    El nuevo diseño con material de protección más flexible aumenta la movilidad y la protección.</li>
              	<li>•    Mayor libertad de movimiento y comodidad, pero protección eficaz para toda la parte delantera del cuerpo.</li>
              	<li>•    Fácil ajuste para diferentes operadores y propósitos.</li>
              	<li>•    Parte del Kit Alfa.</li>
                <li>•    Reglamento CE (UE) 2016/425.</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
              	<li><strong>Número de artículo: </strong>51235685075</li>
              	<li><strong>TALLAS: </strong>XXS/XS, L/XL, 2XL/3XL</li> <br>
