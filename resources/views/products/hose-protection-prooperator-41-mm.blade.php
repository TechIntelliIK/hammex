...
@section('title', 'PROTECCIÓN DE MANGUERA PROOPERATOR 41 MM')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>PROTECCIÓN DE MANGUERA PROOPERATOR 41 MM</li>
        </ol>
        <h2>PROTECCIÓN DE MANGUERA PROOPERATOR 41 MM</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/hose-protection-prooperator-41-mm.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>PROTECCIÓN DE MANGUERA PROOPERATOR 41 MM</h3>
              <h5>Descripción General</h5>
              <ul>
                <li>La lanza se sujeta cerca de partes vitales del cuerpo y las mangueras se rompen, a menudo cerca de acoplamientos y conexiones como en la lanza. Esté más seguro con una protección/cubierta de manguera. ¡La protección/cubierta de la manguera proporciona una protección eficaz para el operador! Ha sido probado para 500 bar / 7500 psi. Una correa ajustable sujeta la cubierta/protección de la manguera de forma segura en su lugar. La protección/cubierta de la manguera es muy suave y flexible. Si compras 10 o más piezas el precio tiene descuento.</li>
              ...
              <ul>
                <li><strong>Número de artículo: </strong>5660045</li>
                <li><strong>TALLAS: </strong>750 mm, 1400 mm</li> <br>
