...
@section('title', 'PROTECCIÓN DE MANGUERA 47 MM, GIRATORIA')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>PROTECCIÓN DE MANGUERA 47 MM, GIRATORIA</li>
        </ol>
        <h2>PROTECCIÓN DE MANGUERA 47 MM, GIRATORIA</h2>
      </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/hose-protection-47mm-swivel.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>PROTECCIÓN DE MANGUERA 47 MM, GIRATORIA</h3>
              <h5>Descripción General</h5>
              <p style="text-align: justify;">
                Nuestro producto más vendido es el de 1 400 mm/4,6 pies de longitud con rótula. El pivote gira libremente alrededor del collar de acero y sigue el movimiento del operador, lo que hace que el trabajo sea más fácil y ergonómico. Los operadores experimentan menos tensión en el cuerpo, ¡y recomendamos enfáticamente usar la rótula! Las mangueras se rompen y los acoplamientos se rompen, a menudo muy cerca del operador y en zonas sensibles del cuerpo, como el abdomen, la axila o el cuello. Estas áreas son difíciles de proteger adecuadamente. Para mejorar aún más la seguridad del operador, se recomienda utilizar una cubierta/protección de manguera. La Protección de Manguera se coloca en la manguera en la conexión a la lanza. Más cerca de la lanza, donde es más probable que se rompa la manguera, hay un collar de acero sólido de 250 mm / 9,8 pulg. Esto proporciona una protección efectiva para el operador ya que ha sido probado para 3000 bar / 43500 psi. Una correa ajustable sujeta la protección/cubierta de la manguera a la lanza. La protección/cubierta de la manguera es suave y flexible.
              </p>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
                <li><strong>Número de artículo: </strong>5060050</li>
                <li><strong>TALLAS: </strong>1400mm</li>
                <table><thead><tr><th colspan="3"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">PROTECCIÓN DE MANGUERA Ø 47 MM / 1.85 IN. </font><font style="vertical-align: inherit;">GIRAR</font></font></th></tr><tr><td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Longitud</font></font></td><td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Arte. </font><font style="vertical-align: inherit;">No.</font></font></td><td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Mod. </font><font style="vertical-align: inherit;">No.</font></font></td></tr></thead><tbody><tr><td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">1400 mm / 4,6 pies</font></font></td><td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">5060050</font></font></td><td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">5942</font></font></td></tr></tbody></table> <br>
