        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/balaclava.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li>•    El pasamontañas, que está hecho de neopreno, está diseñado para mantener el cuerpo seco.</li>
                <li>•    El regazo del pecho está hecho de Cordura equipado con correas ajustables para mantenerlo en su lugar.</li>
                <li>•    El pasamontañas no ofrece protección contra los chorros de agua.</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
                <li><strong>Número de artículo: </strong>5010000</li>
