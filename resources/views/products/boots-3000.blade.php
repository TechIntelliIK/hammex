        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('img/portfolio/tst/boots-3000.webp') }}" alt="">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li>Boots 3000 aguanta “todo” dentro del waterjetting gracias a sus polainas fijas de aluminio. Las polainas están moldeadas y articuladas, lo que proporciona una excelente comodidad y movilidad. No es adecuado para terrenos irregulares y es sensible a las piedras pequeñas. (Para eso recomendamos las polainas). Las botas cumplen con los requisitos establecidos en BGR 191.</li>
                <li>•    Botas de caucho.</li>
                <li>•    Fabricado y certificado según EN ISO 20345:2011 y EN ISO 20347:2012.</li>
                <li>•    Categoría de demanda y/o seguridad S5SRC.</li>
                <li>•    Tipo de zapato 983.</li>
                <li>•    Polaina 100% aluminio, anodizado.</li>
              </ul>
              <h5>Dimensionamiento y número de artículo</h5>
              <ul>
                <li><strong>Número de artículo: </strong>5052080</li>
                <li><strong>TALLAS: </strong>42-48</li> <br>
